...
The raw payload lives in :mod:`modules.shared.assets_data.json` so that the
same source of truth can be consumed by both Python code and the web
application.  This module provides a thin caching layer together with helper
accessors that are convenient for the CLI.
"""
