...
def test_select_targets_runs_music_bed_dry_runs_for_reader_transport_paths() -> None:
    ...
    for path in music_bed_paths:
        ...
        assert (
            "verify-apple-playback-no-regression-candidate" in targets
            or "verify-apple-music-bed-candidate-dry-run" in targets
        ), path
...
def test_select_targets_for_web_changes_runs_web_checks() -> None:
    ...
    assert select_targets(["web/src/hooks/liveMediaClock.ts"]) == [
        "test-web-playback-focused",
        "test-web-full",
        "build-web-production",
    ]
...
def test_select_targets_covers_focused_web_feature_slices() -> None:
    ...
    assert select_targets(["web/src/pages/__tests__/VideoDiscoveryPanel.test.tsx"]) == [
        "test-web-video-dubbing-focused",
        "test-web-full",
        "build-web-production",
    ]
    assert select_targets(["web/src/pages/__tests__/VideoDownloadedListPanel.test.tsx"]) == [
        "test-web-video-dubbing-focused",
        "test-web-full",
        "build-web-production",
    ]
