...
def test_acquisition_provider_inventory_reports_unsupported_default_media_kind() -> None:
    providers = []
    for provider_id, requirements in module.REQUIRED_ACQUISITION_PROVIDERS.items():
        providers.append(
            {
    ...
    assert inventory["acquisition_default_providers_ready"] is False
    assert inventory["acquisition_default_provider_issues"] == ["audio.unsupported"]
...
def test_runtime_create_contract_validation() -> None:
    ...
    assert module.validate_runtime_create_contract(payload) == [
        ...
        "pipelineFilesMinLimit=<missing> expected 1",
        ...
        "pipelineCoverUploadPath=<missing> expected /api/pipelines/covers/upload",
        ...
        "youtubeSubtitlesPath=<missing> expected /api/subtitles/youtube/subtitles",
        "youtubeSubtitleDownloadPath=<missing> expected /api/subtitles/youtube/download",
        "youtubeVideoDownloadPath=<missing> expected /api/subtitles/youtube/video",
        ...
        "youtubeSubtitleDeletePath=<missing> expected /api/subtitles/youtube/delete-subtitle",
        "youtubeVideoDeletePath=<missing> expected /api/subtitles/youtube/delete-video",
        ...
        "bookMetadataPreviewPath=<missing> expected /api/pipelines/metadata/book/lookup",
        "bookMetadataCacheClearPath=<missing> expected /api/pipelines/metadata/book/cache/clear",
