...
def test_music_bed_sync_journey_exercises_reader_music_transport_pair() -> None:
    ...
    assert steps[observed_pause_index + 13] == {
        "action": "assert_value_contains",
        "selector": "e2eMusicBedSyncStatus",
        "text": "bothPlaying=true",
        "platforms": ["tvOS"],
    ...
    assert steps[observed_pause_index + 15] == {
        "action": "assert_value_contains",
        "selector": "e2eMusicBedSyncStatus",
        "text": "guard=false",
        "platforms": ["tvOS"],
    ...
    assert steps[remote_pause_index + 7] == {
        "action": "assert_value_contains",
        "selector": "e2eMusicBedSyncStatus",
    ...
    assert steps[remote_pause_index + 8] == {
        "action": "wait",
        "ms": 100,
        "platforms": ["tvOS"],
    }
    assert steps[remote_pause_index + 9] == {
        "action": "press_remote_button",
        "button": "playPause",
        "platforms": ["tvOS"],
    ...
    assert steps[remote_pause_index + 16] == {
        "action": "assert_value_contains",
        "selector": "e2eMusicBedSyncStatus",
        "text": "music=playing",
        "platforms": ["tvOS"],
    ...
    assert steps[remote_pause_index + 17] == {
        "action": "assert_value_contains",
        "selector": "e2eMusicBedSyncStatus",
        "text": "bothPlaying=true",
        "platforms": ["tvOS"],
    ...
    assert steps[remote_pause_index + 18] == {
        "action": "assert_value_contains",
        "selector": "e2eMusicBedSyncStatus",
        "text": "surface=reader",
        "platforms": ["tvOS"],
    ...
    assert steps[remote_play_index + 2] == {
        "action": "assert_value_contains",
        "selector": "e2eMusicBedSyncStatus",
    ...
    assert steps[remote_play_index + 3] == {
        "action": "assert_value_contains",
        "selector": "e2eMusicBedSyncStatus",
        "text": "reader=playing",
        "platforms": ["tvOS"],
        "timeout": 15,
        "screenshot": "music_bed_remote_play_observed",
    }
    assert {
        "action": "assert_value_contains",
        "selector": "e2eMusicBedSyncStatus",
    ...
    assert steps[remote_second_pause_index + 4] == {
        "action": "assert_value_key_at_least",
        "selector": "e2eMusicBedSyncStatus",
        "key": "readerPauseConfirmations",
        "min_value": 2,
    ...
    assert steps[remote_second_pause_index + 6] == {
        "action": "assert_value_contains",
        "selector": "e2eMusicBedSyncStatus",
        "text": "bothPaused=true",
        "platforms": ["tvOS"],
    ...
    assert steps[shell_resume_index + 7] == {
        "action": "assert_value_contains",
        "selector": "e2eMusicBedSyncStatus",
        "text": "bothPlaying=true",
        "platforms": ["tvOS"],
...
def test_journey_runner_supports_value_contains_assertion() -> None:
    source = JOURNEY_RUNNER.read_text(encoding="utf-8")
    value_body = source.split("private func doAssertValueContains(_ step: JourneyStep)", 1)[1].split(
        "    private func doWait",
        1,
    )[0]
    ...
    assert "if !element.exists {\n                scrollElementIntoView(element, timeout: 1)" in value_body
