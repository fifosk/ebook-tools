...
- `web/src/components/book-narration/BookNarrationForm.tsx` - 903 lines.
  ...
  prefill state mapping, initial shared language/lookup-cache form defaults,
  section metadata merging, edited-field preservation,
