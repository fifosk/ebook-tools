...
- `web/src/components/book-narration/BookNarrationForm.tsx` - 568 lines.
  ...
  coordinator. Static audio/written/voice option lists now pass from their
  ...
  hook coverage while trimming the coordinator to 568 lines.
