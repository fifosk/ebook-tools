...
- Smart resume cards: show "continue listening", "newly completed", and "needs attention" across all surfaces. Status:
  ...
  file and still return the freshest requested entries first.
...
- Web: focused Vitest files plus a production/export build. Use the package
  ...
  the registered Create, saved-template, Library, Video Dubbing, and Subtitle
  Tool focused checks, production/export build, and generated-artifact cleanup.
