...
- `web/src/components/book-narration/BookNarrationForm.tsx` - 848 lines.
  ...
  output-name application, generic field update identity preservation, plus
  default-settings compaction and target-language
