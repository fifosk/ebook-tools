...
Latest simulator-verified release from June 21, 2026: `v2026.06.21.10` with
bundle version `2026062110`. Previous attended iPad deployment proved the same
`2026.6.21` daily release train on the iPad M5 Pro; the `.10` build still needs
