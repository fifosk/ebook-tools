...
deployment. `make verify-apple-music-bed-candidate-dry-run` checks the iPad and
...
manifest slices for auth/session, Library/Search/source, admin/system, admin/config,
pipeline jobs, runtime descriptor, Create, pipeline source, acquisition, audio, reading beds,
