...
struct KeyboardCommandHandler: UIViewControllerRepresentable {
    ...
    final class KeyCommandController: UIViewController {
        ...
        var hardwareKeyboardObserverTokens: [NSObjectProtocol] = []
        var gcLeftControlDown = false
        var gcRightControlDown = false
        var gcLeftShiftDown = false
        var gcRightShiftDown = false
        var gcLeftAltDown = false
        var gcRightAltDown = false
        static weak var activeHardwareKeyboardController: KeyCommandController?

        var gcControlDown: Bool { gcLeftControlDown || gcRightControlDown }
        var gcShiftDown: Bool { gcLeftShiftDown || gcRightShiftDown }
        var gcAltDown: Bool { gcLeftAltDown || gcRightAltDown }
