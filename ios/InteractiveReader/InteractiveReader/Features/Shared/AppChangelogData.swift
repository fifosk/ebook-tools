enum AppChangelogData {
    static let days: [AppChangelogDay] = [
        ...
        AppChangelogDay(
            ...
            entries: july3Entries
        ),
        AppChangelogDay(
            id: "2026-07-02",
            dateLabel: "July 2, 2026",
            version: "2026.07.02.015",
            entries: july2Entries
        ),
        AppChangelogDay(
            id: "2026-07-01",
            dateLabel: "July 1, 2026",
            version: "2026.07.01.001",
            entries: july1Entries
        ),
        AppChangelogDay(
            id: "2026-06-30",
            dateLabel: "June 30, 2026",
            version: "2026.06.30.001",
            entries: june30Entries
        ),
        AppChangelogDay(
            id: "2026-06-29",
            ...
            entries: [
                ...
                AppChangelogEntry(
                    id: "highlighting-policy-safe-stat",
                    title: "Highlighting metadata tolerates storage hiccups",
                    detail: "Playback timing manifests now resolve highlighting policy through the backend's tolerant storage probe, making Web and Apple readers steadier during shared-storage remounts."
                ),
                AppChangelogEntry(
