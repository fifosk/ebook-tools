...
private struct LibraryPlaybackHeader: View {
    let item: LibraryItem
    let coverURL: URL?
...
private struct LibraryPlaybackLoadingView: View {
...
private struct LibraryPlaybackErrorView: View {
    let message: String
    let usesDarkBackground: Bool
...
private struct LibraryPlaybackUnavailableView: View {
    let usesDarkBackground: Bool
