...
enum AppleCreateRuntimeContract {
    ...
    static let youtubeVideoDownloadPath = "/api/subtitles/youtube/video"
    static let youtubeSubtitleDeletePath = "/api/subtitles/youtube/delete-subtitle"
    static let youtubeVideoDeletePath = "/api/subtitles/youtube/delete-video"
