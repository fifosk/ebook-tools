...
ACQUISITION_DESCRIPTOR = _runtime_descriptor.ACQUISITION_DESCRIPTOR
LIBRARY_ACTIONS_DESCRIPTOR = _runtime_descriptor.LIBRARY_ACTIONS_DESCRIPTOR
PIPELINE_JOBS_DESCRIPTOR = _runtime_descriptor.PIPELINE_JOBS_DESCRIPTOR
PIPELINE_MEDIA_DESCRIPTOR = _runtime_descriptor.PIPELINE_MEDIA_DESCRIPTOR
LINGUIST_DESCRIPTOR = _runtime_descriptor.LINGUIST_DESCRIPTOR
