...
checkpoint_line="verify-apple-cross-surface-checkpoint: test-backend-creation-templates test-backend-acquisition test-backend-subtitle-router test-backend-youtube-dubbing-service test-web-create-intake-focused test-web-creation-templates-focused test-web-video-dubbing-focused test-web-subtitle-tool-focused build-web-production verify-apple-local-surfaces"
