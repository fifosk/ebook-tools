...
checkpoint_line="verify-apple-cross-surface-checkpoint: test-backend-library-search-source-isbn test-backend-creation-templates test-backend-pipeline-sources test-backend-acquisition test-backend-subtitle-router test-backend-playback-state test-backend-playback-media test-backend-youtube-dubbing-service test-web-sidebar-focused test-web-create-book-focused test-web-create-intake-focused test-web-creation-templates-focused test-web-library-focused test-web-job-progress-focused test-web-playback-focused test-web-video-dubbing-focused test-web-subtitle-tool-focused test-web-app-view-deeplink-focused build-web-production verify-apple-local-surfaces"
