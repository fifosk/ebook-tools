...
EXPECTED_BOOK_JOBS_PATH = str(EXPECTED_CREATE_PATHS["bookJobsPath"])
EXPECTED_AUDIO_VOICES_PATH = str(EXPECTED_CREATE_PATHS["audioVoicesPath"])
EXPECTED_PIPELINE_DEFAULTS_PATH = str(EXPECTED_CREATE_PATHS["pipelineDefaultsPath"])
EXPECTED_PIPELINE_LLM_MODELS_PATH = str(EXPECTED_CREATE_PATHS["pipelineLlmModelsPath"])
EXPECTED_PIPELINE_SEARCH_PATH = str(EXPECTED_CREATE_PATHS["pipelineSearchPath"])
EXPECTED_IMAGE_NODE_AVAILABILITY_PATH = str(EXPECTED_CREATE_PATHS["imageNodeAvailabilityPath"])
EXPECTED_ACQUISITION_PROVIDERS_PATH = str(EXPECTED_CREATE_PATHS["acquisitionProvidersPath"])
EXPECTED_ACQUISITION_DISCOVER_PATH = str(EXPECTED_CREATE_PATHS["acquisitionDiscoverPath"])
EXPECTED_PIPELINE_FILES_PICKER_MIN_LIMIT = int(EXPECTED_CREATE_PATHS["pipelineFilesMinLimit"])
EXPECTED_PIPELINE_FILES_PICKER_LIMIT = int(EXPECTED_CREATE_PATHS["pipelineFilesDefaultLimit"])
EXPECTED_PIPELINE_FILES_PICKER_MAX_LIMIT = int(EXPECTED_CREATE_PATHS["pipelineFilesMaxLimit"])
