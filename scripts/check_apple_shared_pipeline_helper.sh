...
verify_line="verify-apple-shared-pipeline: apple-pipeline-contracts apple-pipeline-backend apple-pipeline-web-checks"
...
assert_contains "${makefile}" "${verify_line}" "shared pipeline verification should compose contracts, backend checks, and Web checks"
