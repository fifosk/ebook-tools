...
{"result":{"apps":[{"bundleIdentifier":"com.example.InteractiveReader","name":"InteractiveReader","version":"2026.6.25","bundleVersion":"2026062530"}]}}
JSON
...
assert_contains "${fallback_install_output}" "Verified installed app: InteractiveReader com.example.InteractiveReader version=2026.6.25 build=2026062530" "signed-artifact fallback should still verify installed metadata"
...
assert_contains "${stable_install_output}" "Verified installed app: InteractiveReader com.example.InteractiveReader version=2026.6.25 build=2026062530" "stable signed-artifact install should still verify installed metadata"
