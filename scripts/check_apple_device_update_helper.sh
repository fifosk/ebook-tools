...
assert_contains "${makefile}" "\$(if \$(filter 1 YES yes true TRUE,\$(APPLE_DEVICE_LAUNCH_PRESERVE_RUNNING)),--preserve-running-app)" "Makefile launch-console helper should expose state-preserving console capture"
