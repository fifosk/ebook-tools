...
PATH_TARGET_RULES: tuple[tuple[tuple[str, ...], tuple[str, ...]], ...] = (
    ...
    (
        (
            ...
            "docs/testing.md",
            "scripts/apple_build_macos_ipad_style.sh",
            "scripts/apple_find_provisioning_profile.py",
    ...
    (
        (
            ...
            "modules/webapi/routers/acquisition_route_support.py",
    ...
    (
        (
            ...
            "web/src/hooks/liveMedia",
            "web/src/hooks/useLiveMedia.ts",
            "web/src/hooks/__tests__/liveMedia",
            "web/src/hooks/__tests__/useLiveMedia.test.tsx",
            "web/src/hooks/__tests__/useMediaClock.test.tsx",
