...
describe('VideoPlayer', () => {
  ...
  it('renders the active video and notifies when a selection changes', async () => {
    ...
    const { rerender } = render(
      <VideoPlayer files={[trailer]} activeId={trailer.id} onSelectFile={onSelect} autoPlay />,
    );
    ...
    rerender(<VideoPlayer files={[trailer, fullVideo]} activeId={trailer.id} onSelectFile={onSelect} autoPlay />);
    ...
    rerender(<VideoPlayer files={[fullVideo]} activeId={fullVideo.id} onSelectFile={onSelect} autoPlay />);
