...
type VideoDownloadedListPanelProps = {
  isLoading: boolean;
...
export default function VideoDownloadedListPanel({
  isLoading,
  videos,
  selectedVideoPath,
                            ...
                            {availableSubtitleStreams.map((stream) => {
                              ...
                              return (
                                <label key={`${stream.index}-${language || 'unknown'}`} className={styles.streamItem}>
                                  <input
                                    type="checkbox"
                                    aria-label={`Extract ${subtitleStreamLabel(stream)} stream #${stream.index}`}
                                    disabled={disabled}
                                    checked={selected}
