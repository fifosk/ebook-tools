import VideoDubbingLanguageModelSection from './VideoDubbingLanguageModelSection';
import { RESOLUTION_OPTIONS } from './videoDubbingConfig';
  ...
  return (
    <section className={styles.card}>
      ...
      <div className={styles.formFields}>
        <VideoDubbingLanguageModelSection
